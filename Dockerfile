...
RUN CGO_ENABLED=0 GOOS=linux go build -a -installsuffix cgo -o build/restaurant-customer gitlab.com/yevishev/bucketeer
...
EXPOSE 8080 8080
ENTRYPOINT ["/usr/bin/restaurant-customereer"]